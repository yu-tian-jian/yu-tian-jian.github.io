...
围棋系列：围棋狗（打谱软件）、围棋棋力测试（macOS）、围棋水平测试（iOS）、围棋SGF阅读器（iOS）。

象棋系列：象棋学士（打谱软件）、象棋棋力测试（macOS）、象棋水平测试（iOS）、中国象棋PGN阅读器（iOS）。

五子棋系列：五子棋打谱软件（macOS）

国际象棋：国际象棋大亨（macOS）、国际象棋大师 (iOS)。
...
## (7) 围棋棋力测试（macOS）、围棋水平测试（iOS）、围棋SGF阅读器
...
## (9) 象棋棋力测试（macOS）、象棋水平测试（iOS）、中国象棋PGN阅读器（iOS）
...
国际象棋大亨是macOS版本的，iOS 版本的名称是国际象棋大师，主要功能是国际象棋PGN阅读与制作，可以阅读PGN格式的国际象棋棋谱文件，并对棋谱进行演示，同时提供训练模式，用于练习。 还可以制作、保存PGN格式的棋谱文件，具有显示和插入评注的功能，相当于具有打谱功能。
